...
class PositionController extends Controller
{
    ...
    public function getByID(Request $req)
    {
        ...
        else 
        {
            ...
            $data = Position::where(['position_id' => $position_id])->first();
    ...
    public function removeImage(Request $req) 
    {
        ...
        else 
        {
            ...
            $filename = Position::where(['position_id' => $req['position_id']])->first()->image;
            $data = Position::where(['position_id' => $req['position_id']])->update($payload);
            ...
            if ($data)
            {
                ...
                $response = [
                    ...
                    'status' => 'ok',
                    'code' => '201',
                    'data' => Position::where(['position_id' => $req['position_id']])->first()
                ];
            }
            else 
            {
    ...
    public function delete(Request $req)
    {
        ...
        {
            $data = Position::where(['position_id' => $req['position_id']])->delete();
